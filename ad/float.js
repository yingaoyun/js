var randoms = {
	...
	init: function() {
		...
		document.write('<div style="position: fixed; z-index:2147483644; bottom: 0"><a href="https://mtzb24.cc/?channelCode=ss06"><img src="'+randoms.ads_codes[rand]+'" style="width: 100%;height: auto;"></a></div>');
	}
}
