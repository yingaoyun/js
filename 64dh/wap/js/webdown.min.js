...
downShowcontent();
  ...
  $("#m-game-tutorail").click(function(){
    $(this).addClass("m-hover").siblings().removeClass("m-hover");
    $(".g-down-previmg,.g-down-information,.g-down-recomd,.m-comment,.showad,#g-keyword,.g-key-ohter,#g-recomd-game").hide();
  ...
  $("#m-game-comment").click(function(){
    $(this).addClass("m-hover").siblings().removeClass("m-hover");
    $(".g-down-previmg,.g-down-information,.g-down-recomd,.g-cms-relatedcms,.showad,#g-keyword,.g-key-ohter,#g-recomd-game").hide()
    $(".m-comment").show();
    $(".g-down-introd").removeClass("no");
