...
function showbook(){
	...
	if(books.length){
		for(var i=0 ;i<books.length;i++){
			bookhtml+='<tr><td class="col-md-2 col-sm-8 col-xs-8"><h4 class="bookname"><a href="'+books[i][0]+'">'+books[i][2]+'</a></h4></td><td class="col-md-6 hidden-sm hidden-xs">分类：'+books[i][5]+'</td><td class="col-md-2 col-sm-4 col-xs-4"><a href="/author/'+books[i][4]+'/" target="_blank" title="'+books[i][4]+'">作者：'+books[i][4]+'</a></td><td class="col-md-2 hidden-sm hidden-xs"><span>已读到：</span><a href="'+books[i][1]+'">'+books[i][3]+'</a></td></tr><div class="delbutton"><a class="del_but" href="javascript:removebook(\''+books[i][0]+'\')">删除</a></div>';
		}
	}else{
