...
// 搜索框
function searchBox() {
    document.writeln("<form action=\'/search/\' target='_blank' onsubmit=\"return chkval()\"><div class=\'input-group\'><input type=\'search\'class=\'form-control\'placeholder=\'搜索作品\' name=\'searchkey\'><input type=\"hidden\" name=\"searchtype\" value=\"all\"><span class=\'input-group-btn\'><button class=\'btn btn-default\'type=\'submit\'><i class=\'fa fa-search fa-fw\'></i>搜索</button></span></div></form>");
}
...
function showtempbooks(){
	...
	var cover = '';
	/*var bookhtml = '<p class="title jcc">阅读记录：'+books.length+' / '+bookmax+' &nbsp;&nbsp;<a href="javascript:removeall();" onclick="return confirm(\'确定要移除全部记录吗？\')"><i class="fa fa-trash-o fa-lg">&nbsp;</i>清空</a></p><p class="jcc s_gray">本机有效 最近阅读排在最前 到达上限删掉最后</p>';*/
	var bookhtml = '';
	if (books.length){
		for(var i=0 ;i<books.length;i++){
     		 if( i < bookmax ){
				let info_url = '/'+books[i][0]+'/';
				bookhtml += '<div class="col-md-4 col-xs-6 book-coverlist"><div class="row"><div class="col-md-5"><a href="'+books[i][0]+'"><img class="thumbnail" src="'+books[i][5]+'" /></a></div><div class="col-md-7 pl0 mb10"><div class="caption"><h4><a href="'+books[i][0]+'"><b>'+books[i][2]+'</b></a><span>&nbsp;&nbsp;<i class="fa fa-user-circle"></i>&nbsp;'+books[i][4]+'</span></p><p>读到：'+books[i][3]+'</h4><p><a class="bookcase_btn red" href="/'+books[i][1]+'"><i class="fa fa-file-text-o">&nbsp;</i>继续阅读</a>&nbsp;<a class="bookcase_btn gray" href="javascript:removebook(\''+books[i][0]+'\')" onclick="return confirm(\'确定要将本书移除吗？\')"><i class="fa fa-trash-o">&nbsp;</i>移除记录</a></p></div></div></div></div>';
				} 
		}
		bookhtml += '';
   	}else{
	 	bookhtml += '<p><b style="color:red;padding:20px 0;">还没有阅读记录哦 ( ˙﹏˙ )( ˙﹏˙ )，去找找书看吧。</b></p>';
   	}
