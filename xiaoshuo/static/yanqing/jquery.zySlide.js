...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 65, height: 92, top: 9, left: 0, $opacity: 0.3 },
            { '&zIndex': 2, width: 80, height: 110, top: 0, left: 55,$opacity: 1 },
            { '&zIndex': 1, width: 65, height: 92, top: 9, left: 125,$opacity: 0.3 }
        ]
