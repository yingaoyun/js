...
function search(){
    document.write('<form method="post" action="/search/"><input class="searchinput" type="text" name="searchkey" placeholder="请您少字也别错字..." autocomplete="off"><input class="searchgo" type="submit" value="搜索" /></form>');
}
$(window).scroll(function(){
    if($(window).scrollTop()>280){
      $('#gotop, #gofooter').fadeIn(300);
    }else{
      $('#gotop, #gofooter').fadeOut(200);
    }
})
//for big5
var zh_default = 'n';
...
function zh_tran(go){
	if(go) zh_choose = go;
	$.cookie('zh_choose', zh_choose, {expires: zh_expires, path : '/'});
	if(go == 'n'){
