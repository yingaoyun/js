...
var public=checkbrowse();var showeffect="";if((public['is']=='msie'&&public['ver']<8.0)){showeffect="show"}else{showeffect="fadeIn"}jQuery(document).ready(function(jQuery){jQuery("img").lazyload({placeholder:"",effect:showeffect,failurelimit:10})});
