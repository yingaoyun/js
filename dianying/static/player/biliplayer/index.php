...
<body>
<div id="player"></div>
<div class="tj"></script></div>
<script>
    // 播放器基本设置
    var playlink ="<?php echo($_REQUEST['myurl']);?>",urlpar ='DiandianTV';
    var dmapi = 'http://www.jutouba.cc//static/player/danmu/',vodurl = '<?php echo($_REQUEST['url']);?>',vodid="<?php echo($_REQUEST['name']);?>",vodsid="<?php echo($_REQUEST['sid']);?>",vodpic="<?php echo($_REQUEST['pic']);?>",vodname="<?php echo($_REQUEST['name']);?>",next = "<?php echo($_REQUEST['next']);?>",ym="http://v.8e.gs";
