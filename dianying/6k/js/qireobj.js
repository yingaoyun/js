...
jQuery.showfloatdiv = function(ox) {
	...
	if (oxdefaults.wantclose == 1) {
		var floatdiv = $('<div class="tbmovbox-overlayBG" id="tbmovbox_overlay"></div><div id="tbmovbox" class="tbmovbox png-img"><iframe frameborder="0" class="ui-iframe"></iframe><table class="ui-dialog-box"><tr><td><div class="ui-dialog"><div class="ui-dialog-cnt" id="ui-dialog-cnt"><div class="ui-dialog-tip alert" id="ui-cnt"><span id="xtip">'
				+ oxdefaults.txt
				+ '</span></div></div><div class="ui-dialog-close"><span class="close">关闭</span></div></div></td></tr></table></div>');
		$("body").append(floatdiv);
		$("#tbmovbox_overlay").fadeIn(500);
		$("#tbmovbox").fadeIn(500);
		...
		var floatdiv = $('<div class="tbmovbox_overlayBG" id="tbmovbox_overlay"></div><div id="tbmovbox" class="tbmovbox"><iframe frameborder="0" class="ui-iframe"></iframe><div class="ui-dialog"><div class="ui-dialog-cnt" id="ui-dialog-cnt"><div class="ui-dialog-box"<div class="ui-cnt" id="ui-cnt">'
				+ oxdefaults.txt + '</div></div></div></div></div>');
		$("body").append(floatdiv);
		$("#tbmovbox_overlay").fadeIn(500);
		$("#tbmovbox").fadeIn(500);
	}
	$('#tbmovbox_overlay').bind('click', function(e) {
		$.closefloatdiv(e);
		if (pp != null) {
			clearTimeout(pp);
		}
...
qireuser.prototype.gu = function(e) {
    ...
    function(result) {
        ...
        if (result.uid > 0) {
            qruser = result;
			if (parseInt(result.history) > 5) {
				$("#morelog").html('<a target="_blank" href="index.php?s=User-Center-playlog">进入我的赞片查看完整播放记录&gt;&gt;</a>');
				$("#morelog").show();
			} else {
				$("#morelog").html('');
				$("#morelog").hide();
