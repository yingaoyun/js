var popWin = {
	...
	showWin: function(a, b, c, d) {
		...
		h += '<div id="maskTitle" style="height:35px; line-height: 35px; font-family:ËÎÌå; font-size: 14px; font-weight:bold; color: #797979; padding-left: 10px; background: url(./img/hbbg.png); border-bottom: 1px solid #d1d1d1; position: relative;">',
		h += "" + c,
		h += '<div id="popWinClose" style="width: 15px; height:15px; cursor: pointer; position: absolute; top:10px; right: 9px; background: url(./img/closehdtipper.png)"></div>',
		h += "</div>",
	...
	mouseClose: function() {
		...
		function() {
			$(this).css("background-image", "url(../img/closehdtipper.png)")
		}),
